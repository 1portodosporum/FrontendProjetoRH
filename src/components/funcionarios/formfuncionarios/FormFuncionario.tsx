...
const FormFuncionario = () => {
    return (
        <section className="container flex flex-col items-center justify-center mx-auto">
            <h1 className="text-4xl text-center my-8">Formulario de Funcionario</h1>
            <form className="w-1/2 flex flex-col gap-4">
                ...
                <label><i className='bx bxs-calendar' ></i> data adimissão:</label>
                    <input type="date"  required/>
                </div>
                <div className="flex flex-col gap-4">
                    <label><i className='bx bx-buildings'></i> Departamento:</label>
